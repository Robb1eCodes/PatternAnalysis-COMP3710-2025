...
# Number of mask classes in the mask images
NUM_CLASSES = 6

# Where the model values should be saved
...
# Resize image if necessary for faster training (256,128 default)
TARGET_IMG_SHAPE = (256, 128)

def main():

    print('Loading train data...')
    # Load all the .nii files within the relevant directories
    ...
    # Add model callbacks for Checkpointing, Reducing learning rate, and early stopping
    callbacks = [
    ...
    # Fit all the model parameters to the model (train the model)
